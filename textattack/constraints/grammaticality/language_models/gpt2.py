...
class GPT2(LanguageModelConstraint):
    ...
    def __init__(self, **kwargs):
        ...
        self.model = transformers.GPT2LMHeadModel.from_pretrained('data/aitest/models/gpt-2/models--gpt2/Snapshots/e7da7f221d5bf496a48136c0cd264e630fe9fcc8')
        self.model.to(utils.device)
        self.tokenizer = transformers.GPT2Tokenizer.from_pretrained('data/aitest/models/gpt-2/models--gpt2/Snapshots/e7da7f221d5bf496a48136c0cd264e630fe9fcc8')

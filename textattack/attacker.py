...
class Attacker:
    ...
    def __init__(self, attack, dataset, attack_args=None):
        ...
        assert isinstance(
            dataset, textattack.datasets_text_attack.Dataset
    ...
    def _attack(self, log_method):
        ...
        while worklist:
            # TODO: LLM POST
            # requests.post(url='http://127.0.0.1:5002/llm', json={'data': {'new_question': '1'}}, verify=False)
            ...
            if log_method is not None:
                log_method.insert_log(content=log_method.log_attack_result(number=num_results, result=result))
    ...
    def _attack_parallel(self, log_method):
    ...
    def attack_dataset(self, log_method=None):
        """Attack the dataset.
        ...
        if self.attack_args.parallel:
            ...
            self._attack_parallel(log_method)
        else:
            self._attack(log_method)

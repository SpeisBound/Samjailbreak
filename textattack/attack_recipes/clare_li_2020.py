...
class CLARE2020(AttackRecipe):
    ...
    def build(model):
        ...
        shared_masked_lm = transformers.AutoModelForCausalLM.from_pretrained('data/aitest/models/hub/models--distilroberta-base')
        shared_tokenizer = transformers.AutoTokenizer.from_pretrained('data/aitest/models/hub/models--distilroberta-base')

...
class HardLabelMaheshwary2021(AttackRecipe):
    ...
    def build(model):
        ...
        # goal_function:stipulate the goal of the attack, like to change the prediction score of a classification
        # model, or to change all of the words in a translation output. constraints:determine if a potential

        # perturbation is valid with respect to the original input.

        # transformation:take a text input and transform it
        # by inserting and deleting characters, words, and/or phrases.

        # search_method:explore the space of possible transformations within the defined constraints and attempt to
        # find a successful perturbation which satisfies the goal function.
